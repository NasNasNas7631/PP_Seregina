...
response = requests.put(
    'http://10.0.0.193:8080/user/anna',
    {'password': 'fsdv4w5#'}
)
print(response.json())
...
response = requests.put(
    'http://10.0.0.193:8080/user/loca',
    {'password': 'fsdv4w5#'}
)
print(response.json())
...
response = requests.get('http://10.0.0.193:8080/user/anna')
print(response.json())

print('Удаление пользователя:')
response = requests.delete('http://10.0.0.193:8080/user/loca')
print(response.text)
